...
import oleksii.filonov.interview.tasks.datastructures.arrays.MaxUniqueElementsSubArrayFinder;

public class MaxUniqueElementsSubArrayFinderTest {
	...
	private int findMaximum(String inputFile) throws FileNotFoundException {
		...
		int maximum = MaxUniqueElementsSubArrayFinder.findMaximumUniqueSubArray(input.maxSubarray, input.elements);
		return maximum;
	}
	...
	public void testInput04() throws FileNotFoundException {
		assertEquals(7, findMaximum("MaxUniqueSubArrayFinderInput04.txt"));
	}
}
